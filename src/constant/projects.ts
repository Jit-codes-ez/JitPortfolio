export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Research project on side-channel attack resistance of ML-KEM (CRYSTALS-Kyber). Used Conditional GANs to augment power trace data for improved attack modeling — manuscript under review for book publication. Certificate awarded.",
    github_link: "https://github.com/Jit-codes-ez",
    demo: "",
