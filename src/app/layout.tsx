...
export const metadata: Metadata = {
  ...
  verification: {
  google: "zEeMPPq4QXu81wCp1mZxTFeGntHFixaPFoQHb6Y1-Yk",
  },
  appleWebApp: {
    capable: true,
    title: "Jit Hazra",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jit Hazra Portfolio Thumbnail",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Jit Hazra",
    description:
      "Check out Jit Hazra’s personal portfolio and dev projects using Next.js, React, Tailwind, and modern web tech.",
