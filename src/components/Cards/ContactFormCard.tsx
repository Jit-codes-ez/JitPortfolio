...
export const ContactFormCard = () => {
  ...
  className="w-full px-6 py-3 rounded-xl font-medium text-base flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-white"
  style={{
    background: "linear-gradient(135deg, hsl(var(--secondary)) 0%, hsl(var(--accent)) 100%)",
    boxShadow: "0 8px 25px hsl(var(--secondary) / 0.3)",
  }}
>
              {isSending ? (
                <>
